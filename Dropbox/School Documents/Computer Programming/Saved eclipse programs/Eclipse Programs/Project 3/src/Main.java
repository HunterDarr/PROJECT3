...
public class Main 
{
	public static void main(String[] args) throws IOException 
	{
		 ...
		 */
		int vlaueOfSecondNow = dateTimeOne.getValueOfSecond();   //DONE
		/**
		...
		{
			dateTimeOne.sleepForFiveSec();   //DONE
		}
	    ...
	    dateTimeOne.dateTimeNow();	      //I THINK ITS DONE
		 ...
		 * The output is here (pls look at the text sample, if needed).
			...
			CST (90W): 15:14
		 */
	    dateTimeOne.dateTimeOfOtherCity();   //DONE
		 ...
		 */
	    dateTimeOne.dateTimeDifferentZone();  //DONE
	    System.out.println("\n");	    
	    ...
	    dateTimeTwo.daysOfCurrentMonth();   //DONE
	    System.out.println("\n");
	    ...
	    dateTimeTwo.daysOfAnyMonth(2, 2020);//DONE
